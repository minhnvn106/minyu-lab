...
if ( $showContent ) {
    ...
    // Excerpt Words below 1 (0 or -1) shows the whole excerpt, the same as the editor preview.
    $content  = $block_object->truncate( wp_kses_post( wp_strip_all_tags( $_content ) ), (int) $contentLength > 0 ? $contentLength : -1 );
